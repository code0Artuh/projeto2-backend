...
router.get('/listname/:id', async (req,res) => {
    ...
    await paise.findOne({ _id:id }).then((paises) => { //findOne retorna o primeiro que der match com o item passado
        console.log(paises);
...
router.put('/edit/:id', async (req,res) => { //edita paise no banco
